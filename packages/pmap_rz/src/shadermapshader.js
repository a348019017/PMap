...
//   fsSource += `
//         vec4 helsing_visibleAreaColor=vec4(1.0,0.0,0.0,1.0);
//         vec4 helsing_unvisibleAreaColor=vec4(0.0,1.0,0.0,1.0);
//         if(visibility>0.3){
//             gl_FragColor=mix(gl_FragColor,helsing_visibleAreaColor,.5);
//         }else
//         {
//             gl_FragColor=mix(gl_FragColor,helsing_unvisibleAreaColor,.5);
//         }
//     }
//   `;
